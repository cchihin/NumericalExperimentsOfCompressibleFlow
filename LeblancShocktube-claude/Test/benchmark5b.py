...
OUT       = os.path.join(HERE, 'Benchmark5b')
os.makedirs(OUT, exist_ok=True)

log_fh = open(os.path.join(OUT, 'benchmark5b.log'), 'w', buffering=1)
def log(msg=''):
...
SKAPPA     = -1.3
KAPPA      = 0.2
TANH_WIDTH = 0.1        # best IC from Phase 4
CFL_C      = 0.04
XL, XR     = -3.0, 15.0
X0         = 3.0
T_FINAL    = 10.0
...
json.dump(dump, open(os.path.join(OUT, 'results5b.json'), 'w'), indent=2)
